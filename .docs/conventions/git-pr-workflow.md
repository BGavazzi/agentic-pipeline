# Convention — Git / PR Workflow (org-wide)
...
Repos **without deployment** (docs/tooling like `guidelines_IA`, libs) continue with base = **`main`** directly (not master/develop/staging).
