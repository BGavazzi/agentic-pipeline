...
HIGH_RISK_PATH_PATTERNS = [
    ...
    (r"^scripts/(validate_task|validate_closure|scan_gate|blast_radius|quota_gate|admission_gate|ci_receipts|integration_gate|impact_runner|impact_benchmark|harness_selftest|policy_integrity|ultrareview_receipt|ultrareview_runner|quality_scorecard|test_impact|visual_receipt|staging_gate|worker_preflight|infra_dry_run|staging_pr)\.py$", "gate-script"),
