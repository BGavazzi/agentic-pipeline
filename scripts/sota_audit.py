...
CAPABILITIES: tuple[dict[str, Any], ...] = (
    ...
    _capability("intent-authorization", "Intent scope, data and effect contract", "trust",
                implementation=("scripts/intent_gate.py",), tests=("tests/test_intent_gate.py",),
                docs=(".docs/tasks/0081-feat-intent-authorization-gate.md",),
                external=("protected intent producer", "admission wiring", "business-policy authority"),
                note="The exact-diff contract is present; protected authorization and admission consumption remain external."),
    ...
    _capability("receipt-admission", "Versioned receipts and deterministic admission", "trust",
                implementation=("scripts/ci_receipts.py", "scripts/admission_gate.py", "scripts/admission_mutation_benchmark.py", "scripts/quality_scorecard.py"),
                tests=("tests/test_ci_receipts.py", "tests/test_admission_gate.py", "tests/test_admission_mutation_benchmark.py"),
                ci=(".github/workflows/ci.yml",)),
    _capability("clean-room-integration", "Exact-tree integration execution", "correctness",
                implementation=("scripts/integration_gate.py", "scripts/local_integration_loop.py"),
                tests=("tests/test_integration_gate.py", "tests/test_local_integration_loop.py"),
                ci=(".github/workflows/ci.yml",),
                note="The bounded local merge/bundle loop exists; trusted external activation remains external."),
    ...
    _capability("agent-behavior-evals", "Fixture-based agent/skill evaluation", "agentic",
                implementation=("scripts/meta_test.py", "scripts/meta_test_dispatch.py", "scripts/harness_selftest.py", "scripts/agent_eval_corpus.py"),
                tests=("tests/test_meta_test.py", "tests/test_meta_test_dispatch.py", "tests/test_harness_selftest.py", "tests/test_agent_eval_corpus.py"),
    ...
    _capability("worker-boundary", "Disposable worker boundary and lifecycle evidence", "security",
                implementation=("scripts/worker_preflight.py", "scripts/worker_supervisor.py"),
                tests=("tests/test_worker_preflight.py", "tests/test_worker_supervisor.py"),
    ...
    _capability("test-result-history", "Scalable result listener and selector history", "scale",
                ...
                note="JUnit normalization is wired to evidence; durable cross-run history is still external."),
    _capability("artifact-provenance-sbom", "Signed artifact provenance and SBOM verification", "supply-chain",
                implementation=("scripts/provenance_verify.py",),
                tests=("tests/test_release_provenance_workflow.py",),
                ci=(".github/workflows/release-provenance.yml",),
    ...
    _capability("hermetic-reproducible-builds", "Pinned, hermetic and reproducible execution", "correctness",
                ...
                tests=("tests/test_environment_fingerprint.py",),
                ci=("requirements-ci.txt", "scripts/environment_fingerprint.py"),
                external=("pinned dependency lock/constraints", "reproducible toolchain image", "network policy"),
                note="Pinned CI dependencies and fingerprints are present; archive isolation does not make the OS/toolchain fully hermetic."),
    ...
    _capability("ci-observability", "CI/CD telemetry, queue and SLO visibility", "operations",
                implementation=("scripts/quality_metrics_dashboard.py", "scripts/receipt_journal.py", "scripts/ci_telemetry.py", "scripts/kpi_history.py"),
                tests=("tests/test_quality_metrics_dashboard.py", "tests/test_receipt_journal.py", "tests/test_ci_telemetry.py", "tests/test_kpi_history.py"),
                ci=(".github/workflows/ci.yml",),
                docs=(".docs/tasks/0041-feat-receipt-journal.md",),
    ...
    _capability("merge-release-safety", "Merge queue, deployment verification and rollback", "operations",
                implementation=("scripts/merge_group_contract.py", "scripts/release_health_gate.py"),
                tests=("tests/test_merge_group_contract.py", "tests/test_merge_group_workflow.py", "tests/test_release_health_gate.py"),
                ci=(".github/workflows/ci.yml",),
