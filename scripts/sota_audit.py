...
CAPABILITIES: tuple[dict[str, Any], ...] = (
    ...
    _capability("ci-observability", "CI/CD telemetry, queue and SLO visibility", "operations",
                implementation=("scripts/quality_metrics_dashboard.py", "scripts/receipt_journal.py", "scripts/ci_telemetry.py"),
                tests=("tests/test_quality_metrics_dashboard.py", "tests/test_receipt_journal.py", "tests/test_ci_telemetry.py"),
                ci=(".github/workflows/ci.yml",),
                docs=(".docs/tasks/0041-feat-receipt-journal.md",),
